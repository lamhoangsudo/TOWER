...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void RecordAnimationEvents(ref SystemState ss, Entity rce, ref RecordComponent rc)
	{
		...
		var aecs = SystemAPI.GetBuffer<AnimationEventComponent>(rce);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int RecordAnimatorState(in AnimatorControllerLayerComponent aclc, int stateId, ref RecordComponent rc)
	{
		if (stateId < 0)
			return -1;
		
		var shd = new AnimatorControllerStateHistoryData(aclc, stateId, frameCounter);
		...
		{
			var cs = csh[i];
			if (cs.stateId == shd.stateId && cs.frameSpan.y + 1 == frameCounter && cs.layerIndex == shd.layerIndex)
				break;
		}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void RecordAnimatorStates(ref SystemState ss, Entity rce, ref RecordComponent rc)
	{
		...
		{
			var aclc = aclcs[i];
			var srcStateDataIndex = RecordAnimatorState(aclc, aclc.rtd.srcState.id, ref rc);
			var dstStateDataIndex = RecordAnimatorState(aclc, aclc.rtd.dstState.id, ref rc);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void RecordAnimatorEvents(ref SystemState ss, Entity rce, ref RecordComponent rc)
	{
		...
		var acecs = SystemAPI.GetBuffer<AnimatorControllerEventComponent>(rce);
