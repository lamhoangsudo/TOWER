...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.Physics
{
    ...
    [NodeDescription("Returns success when a collision ends. This task will only receive the physics callback if it is being reevaluated (with a conditional abort or under a parallel task).")]
