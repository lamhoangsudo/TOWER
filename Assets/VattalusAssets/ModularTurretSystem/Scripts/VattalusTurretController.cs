...
public class VattalusTurretController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Mathf.Abs(currHeadingRotSpeed) > 0.5f)
            {
                ...
                HeadingRotationSFX.volume = Mathf.Lerp(0f, 0.5f, headingSpeedFactor);
            }
            else
            {
        ...
        {
            if (Mathf.Abs(currElevationRotSpeed) > 0.5f)
            {
                float elevationSpeedFactor = Mathf.Abs(currElevationRotSpeed) / ElevationRotationSpeed;
                ...
                ElevationRotationSFX.volume = Mathf.Lerp(0f, 0.2f, elevationSpeedFactor);
            }
            else
            {
